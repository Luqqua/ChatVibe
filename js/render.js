...
export function displayResults(analysisResults) {
    ...
    if (!analysisResults.highlights || analysisResults.highlights.length === 0) {
      ...
      noHighlightsMsg.textContent = "No highlights found. The current analysis settings might be too strict. Check the settings. Using the default settings is recommended.";
